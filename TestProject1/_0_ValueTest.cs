...
namespace TestProject1
{
    ...
    public class _0_ValueTest
    {
        ...
        public void ValueTypeAdaptersTest()
        {
            ...
            obj = (double)6.666;
            bytearray = ValueTypeAdapter.GetBytes(out lengh, obj, EndianType.Big);
            obj_2 = ValueTypeAdapter.GetValue<double>(out lengh, bytearray, EndianType.Big);
            Assert.Equal(obj, obj_2);

            //int
            obj = (int)6.666;
            bytearray = ValueTypeAdapter.GetBytes(out lengh, obj, EndianType.Big);
            obj_2 = ValueTypeAdapter.GetValue<int>(out lengh, bytearray, EndianType.Big);
            Assert.Equal(obj, obj_2);

            //uint
            obj = (uint)54;
            bytearray = ValueTypeAdapter.GetBytes(out lengh, obj, EndianType.Big);
            obj_2 = ValueTypeAdapter.GetValue<uint>(out lengh, bytearray, EndianType.Big);
            Assert.Equal(obj, obj_2);

            //longint
            obj = (long)554;
            bytearray = ValueTypeAdapter.GetBytes(out lengh, obj, EndianType.Big);
            obj_2 = ValueTypeAdapter.GetValue<long>(out lengh, bytearray, EndianType.Big);
            Assert.Equal(obj, obj_2);

            //ulong
            obj = (ulong)223;
            bytearray = ValueTypeAdapter.GetBytes(out lengh, obj, EndianType.Big);
            obj_2 = ValueTypeAdapter.GetValue<ulong>(out lengh, bytearray, EndianType.Big);
            Assert.Equal(obj, obj_2);

            //enum
            obj = (EnumType)6;
            bytearray = ValueTypeAdapter.GetBytes(out lengh, obj, EndianType.Big);
            obj_2 = ValueTypeAdapter.GetValue<EnumType>(out lengh, bytearray, EndianType.Big);
            Assert.Equal(obj, obj_2);
